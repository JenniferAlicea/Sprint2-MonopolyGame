...
public class Gameboard {
    ...
    public void initializeBoard() {
        ...
        //square 7
        squares.add(new BoardSquare("Chance Card", 7));
        //square 8
        ...
        //square 10
        squares.add(new BoardSquare("Jail/Just Visiting", 10));
        //square 11
        ...
        //square 17
        squares.add(new BoardSquare("Community Chest Card", 17));
        ...
        //square 20
        squares.add(new BoardSquare("Free Parking", 20));
        ...
        //square 22
        squares.add(new BoardSquare("Chance Card", 22));
        ...
        //square 30
        squares.add(new BoardSquare("Go to Jail", 30));
        ...
        //square 33
        squares.add(new BoardSquare("Community Chest Card", 33));
        ...
        //square 36
        squares.add(new BoardSquare("Chance Card", 36));
        ...
        //square 38
        squares.add(new BoardSquare("Luxury Tax", 38));
